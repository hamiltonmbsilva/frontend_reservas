...
const hoteisMock = [
  {
    id: 1,
    nome: "Hotel HDS Premium",
    cidade: "Juiz de Fora",
    estado: "MG",
    pais: "Brasil",
    imagem_principal_url: "/images/galeria/img1.jpeg",
  },
  {
    id: 2,
    nome: "ReservaMB Palace",
    cidade: "Matias Barbosa",
    estado: "MG",
    pais: "Brasil",
    imagem_principal_url: "/images/galeria/img2.jpeg",
  },
  {
    id: 3,
    nome: "HDS Business Hotel",
    cidade: "Rio de Janeiro",
    estado: "RJ",
    pais: "Brasil",
    imagem_principal_url: "/images/galeria/img3.jpeg",
  },
];

export default function HoteisClientPage() {
  ...
  useEffect(() => {
    async function carregarHoteis() {
      try {
        ...
        setErro("API indisponível. Exibindo dados demonstrativos HDS.");
    ...
    <main className={styles.page}>
      <section className={styles.hero}>
        ...
        <p>
          ...
          o projeto em uma plataforma profissional.
        </p>
      </section>
      ...
      <section className={styles.filters}>
        ...
        <button type="button" onClick={() => { setBusca(""); setEstado(""); }}>
          Limpar filtros
        </button>
      </section>
